...
**"snapchat-scraper security"** in the subject — otherwise it lands in a queue
...
- **Bypassing Snapchat's bot protection.** This scraper reads what
  Snapchat serves and reports a challenge as a challenge. How Snapchat's own
  captcha behaves is not a vulnerability in this repository.
- **The scraper stopped working.** Snapchat changing its pages is expected —
